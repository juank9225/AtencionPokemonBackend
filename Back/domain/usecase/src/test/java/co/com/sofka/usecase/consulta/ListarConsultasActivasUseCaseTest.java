...
@SpringBootTest(classes = ListarConsultasActivasUseCase.class)
class ListarConsultasActivasUseCaseTest {
    @MockBean
    private ConsultaRepository consultaRepository;

    @SpyBean
    private ListarConsultasActivasUseCase listarConsultasActivasUseCase;

    @Test
    @DisplayName("Happy Test listar consalta activas")
    public void consultasActivasHappyTest(){
        ...
        Mockito.when(consultaRepository.listarConsultasActivas("30-07-201")).thenReturn(consultas);

        List<Consulta> resp =  listarConsultasActivasUseCase.listarConsultasActivas("30-07-201");
    ...
    @Test
    @DisplayName("Sab Test listar consalta activas")
    public void consultasActivasSabTest(){
